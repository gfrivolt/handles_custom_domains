...
By default the table_prefix used is stored in the field _table_name_prefix_.
...
The value of _table_name_prefix_ can not be changed after the creation of the record. If it changes, the record is invalid.
